  ...
  return [
    {
      ...
      body: {
        zh: `${projectName} 当前处于初步决策草稿阶段。建议先完善输入资料，再形成正式推荐结论。`,
        en: `${projectName} is currently in an initial decision-draft stage. Complete the inputs before issuing a formal recommendation.`,
      },
      assumptions: [{ zh: "当前尚未读取附件内容。", en: "Attachment contents have not been read yet." }],
      uncertainty: { zh: "完整性取决于人工录入的信息质量。", en: "Confidence depends on the quality of manually entered inputs." },
      dataSourcesUsed: [{ zh: "项目 Intake", en: "Project intake" }, { zh: "平台基础资料", en: "Platform reference information" }],
      lastGeneratedAt: now,
    },
    {
      id: "project-inputs",
    ...
    },
    {
      ...
      assumptions: [{ zh: "基础平台评分来自当前平台资料。", en: "Base platform scores come from the current platform reference information." }],
    ...
    },
    {
      ...
      assumptions: [{ zh: "路线图需要结合现场约束和实施资源进一步确认。", en: "The roadmap requires confirmation against site constraints and delivery resources." }],
    ...
    {
      id: "assumptions",
      title: { zh: "分析依据与结论限制", en: "Analysis Basis & Conclusion Limits" },
      body: {
        zh: "当前尚未读取附件内容，也不会连接 PLC。所有结论用于早期决策讨论。",
        en: "Attachment contents have not been read, and the application does not connect to PLCs. All conclusions support early decision discussions.",
      },
      assumptions: [{ zh: "关键分析依据需要用户确认。", en: "Key analysis inputs require user confirmation." }],
      uncertainty: { zh: "正式推荐前需要补充真实工程、成本和交付数据。", en: "Formal recommendation requires real engineering, cost, and delivery data." },
      dataSourcesUsed: [{ zh: "用户输入", en: "User input" }, { zh: "当前评分结果", en: "Current scoring results" }],
      lastGeneratedAt: now,
    },
  ];
}
