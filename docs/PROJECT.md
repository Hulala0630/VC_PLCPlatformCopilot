...
The 2026-06-30 checkpoint is `MVP v0.1 Engineer Trial Ready`. The acceptance criteria and trial script are documented in `docs/MVP_ENGINEER_TRIAL.md`.

2026-06-30 的阶段目标是 `MVP v0.1 Engineer Trial Ready`。验收标准和试用脚本位于 `docs/MVP_ENGINEER_TRIAL.md`。
