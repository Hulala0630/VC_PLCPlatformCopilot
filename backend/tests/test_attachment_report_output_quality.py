...
class AttachmentReportOutputQualityTests(unittest.TestCase):
    ...
    def test_attachment_analysis_reads_like_consultant_note(self) -> None:
        ...
        self.assertIn("registered materials", content)
        self.assertIn("what they can support", content)
        self.assertIn("what they cannot support yet", content)
        self.assertIn("missing documents", content)
        self.assertIn("impact on benchmark confidence", content)
        self.assertIn("impact on report quality", content)
        self.assertIn("decision next step", content)
    ...
    def test_report_generation_reads_like_consultant_report_draft(self) -> None:
        ...
        self.assertNotIn("how this report was generated", content)
        self.assertNotIn("generated by ai", content)
        self.assert_no_banned_terms(content)
